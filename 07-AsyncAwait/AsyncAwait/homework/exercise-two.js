...
async function problemA () {
  ...
  await randompoems('poem-two/stanza-01.txt');
  await randompoems('poem-two/stanza-02.txt');
  console.log('done')
}
...
async function problemB () {
  ...
  const TODOSLOSPOEMAS = filenames.map(stanzas => randompoems(stanzas))
  await Promise.all(TODOSLOSPOEMAS);
  console.log('done')
